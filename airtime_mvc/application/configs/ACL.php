...
$ccAcl->add(new Zend_Acl_Resource('library'))
      ...
      ->add(new Zend_Acl_Resource('soundcloud-import'))
      ->add(new Zend_Acl_Resource('usim-direct-import'))
      ->add(new Zend_Acl_Resource('dropbox-import'))
...
$ccAcl->allow('G', 'index')
      ...
      ->allow('H', 'plupload')
      ->allow('H', 'soundcloud-import')
      ->allow('H', 'usim-direct-import')
      ->allow('H', 'dropbox-import')
      ->allow('H', 'library')
      ->allow('H', 'playlist')
